...
#loop boss ai
execute at @r if entity @e[type=item_display,tag=aj.annihilation_recreated.root,distance=..128] run execute as @e[type=item_display,tag=aj.annihilation_recreated.root,distance=..128] at @s run function annihilation:boss/main_ai
