...
#hitbox
summon magma_cube ~ ~ ~ {NoGravity:1b,Silent:1b,CustomNameVisible:0b,DeathLootTable:"minecraft:empty",PersistenceRequired:1b,NoAI:1b,CanPickUpLoot:0b,Health:800f,Size:16,Tags:["anni_hitbox","anni_immune"],CustomName:'{"text":"Annihilation","color":"dark_red"}',ActiveEffects:[{Id:12,Amplifier:5b,Duration:-1,ShowParticles:0b},{Id:14,Amplifier:1b,Duration:-1,ShowParticles:0b}],Attributes:[{Name:generic.max_health,Base:800},{Name:generic.armor,Base:5}],HandItems:[{id:"minecraft:wooden_axe",Count:1b,tag:{Unbreakable:1b}},{}],HandDropChances:[0.000F,0.085F]}
...
execute if score #anniR_global anniR_difficulty matches 1 run execute at @s run data merge entity @e[type=magma_cube,tag=anni_hitbox,nbt={NoAI:1b},limit=1,sort=nearest,distance=..2] {Health:8000,Attributes:[{Name:generic.max_health,Base:8000},{Name:generic.armor,Base:10}]}
execute if score #anniR_global anniR_difficulty matches 2 run execute at @s run data merge entity @e[type=magma_cube,tag=anni_hitbox,nbt={NoAI:1b},limit=1,sort=nearest,distance=..2] {Health:250000,Attributes:[{Name:generic.max_health,Base:250000},{Name:generic.armor,Base:20}]}
