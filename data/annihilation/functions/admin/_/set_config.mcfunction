...
execute if score #anniR_global anniR_infsub_grief matches 1 run tellraw @p [{"text":"  ","underlined":false},{"color":"gray","hoverEvent":{"action":"show_text","value":[{"text":"infernal subjugate will destroy block when spawned to prevent suffocation"}]},"text":"set infernal subjugate grief :","underlined":true},{"text":" ","underlined":false},{"color":"green","text":"[on]","underlined":false},{"text":"  ","underlined":false},{"clickEvent":{"action":"run_command","value":"/function annihilation:admin/config/infsub_grief_off"},"color":"red","underlined":false,"text":"off"}]
execute if score #anniR_global anniR_infsub_grief matches 0 run tellraw @p [{"text":"  ","underlined":false},{"color":"gray","hoverEvent":{"action":"show_text","value":[{"text":"infernal subjugate will destroy block when spawned to prevent suffocation"}]},"text":"set infernal subjugate grief :","underlined":true},{"text":" ","underlined":false},{"clickEvent":{"action":"run_command","value":"/function annihilation:admin/config/infsub_grief_on"},"color":"red","underlined":false,"text":"on"},{"text":"  ","underlined":false},{"color":"green","text":"[off]","underlined":false}]
tellraw @s [{"text":" "}]
