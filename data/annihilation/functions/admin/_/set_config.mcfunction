...
execute if score #anniR_global anniR_infsub_grief matches 0 run tellraw @p [{"color":"gray","hoverEvent":{"action":"show_text","value":[{"text":"infernal subjugate will destroy block when spawned to prevent suffocation"}]},"text":"set infernal subjugate grief :","underlined":true},{"color":"white","text":"                             ","underlined":false},{"clickEvent":{"action":"run_command","value":"/function annihilation:admin/config/infsub_grief_on"},"color":"red","text":"on"},{"text":"    ","underlined":false},{"bold":true,"color":"green","text":"off","underlined":true}]
tellraw @s [{"text":" "}]

#new_sun instakill
execute if score #anniR_global anniR_newsun_kill matches 1 run tellraw @p [{"color":"gray","hoverEvent":{"action":"show_text","value":[{"text":"new sun will instakill target and player"}]},"text":"set new sun instakill :","underlined":true},{"color":"white","text":"                                        ","underlined":false},{"bold":true,"color":"green","text":"on","underlined":true},{"text":"    ","underlined":false},{"clickEvent":{"action":"run_command","value":"/function annihilation:admin/config/newsun_kill_off"},"color":"red","text":"off"}]
execute if score #anniR_global anniR_newsun_kill matches 0 run tellraw @p [{"color":"gray","hoverEvent":{"action":"show_text","value":[{"text":"new sun will instakill target and player"}]},"text":"set new sun instakill :","underlined":true},{"color":"white","text":"                                        ","underlined":false},{"clickEvent":{"action":"run_command","value":"/function annihilation:admin/config/newsun_kill_on"},"color":"red","text":"on"},{"text":"    ","underlined":false},{"bold":true,"color":"green","text":"off","underlined":true}]
tellraw @s [{"text":" "}]