scoreboard players set @s anniR_abilityCooldown 120
...
execute positioned ^-2 ^ ^70 run function annihilation:boss/summons/magma_hulk
execute positioned ^2 ^ ^70 run function annihilation:boss/summons/magma_hulk

execute positioned ^-4 ^ ^75 run function annihilation:boss/summons/bighorn_devil
execute positioned ^ ^ ^75 run function annihilation:boss/summons/bighorn_devil
execute positioned ^4 ^ ^75 run function annihilation:boss/summons/bighorn_devil

execute positioned ^-7 ^ ^70 run function annihilation:boss/summons/mayhem_imp
execute positioned ^7 ^ ^70 run function annihilation:boss/summons/mayhem_imp