...
execute at @e[tag=anni_target,tag=!anni_immune,limit=1,distance=9..128] run summon armor_stand ~ ~16 ~2 {NoGravity:0b,Invulnerable:1b,HasVisualFire:1b,Glowing:1b,Invisible:1b,Tags:["anni_immune","anni_meteor_b","anni_summoned"],Pose:{Head:[180f,0f,0f]},DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_glazed_terracotta",Count:1b}]}
execute at @e[tag=anni_target,tag=!anni_immune,limit=1,distance=9..128] run summon armor_stand ~-2 ~16 ~-2 {NoGravity:0b,Invulnerable:1b,HasVisualFire:1b,Glowing:1b,Invisible:1b,Tags:["anni_immune","anni_meteor_b","anni_summoned"],Pose:{Head:[180f,0f,0f]},DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_glazed_terracotta",Count:1b}]}
execute at @e[tag=anni_target,tag=!anni_immune,limit=1,distance=9..128] run summon armor_stand ~2 ~16 ~-2 {NoGravity:0b,Invulnerable:1b,HasVisualFire:1b,Glowing:1b,Invisible:1b,Tags:["anni_immune","anni_meteor_b","anni_summoned"],Pose:{Head:[180f,0f,0f]},DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:black_glazed_terracotta",Count:1b}]}
