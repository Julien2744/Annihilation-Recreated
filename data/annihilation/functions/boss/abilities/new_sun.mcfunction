...
#team
execute if score #anniR_global anniR_team matches 1 run team join annihilation_team @e[type=magma_cube,tag=anni_immune,tag=new_sun_hitbox,distance=..16,limit=1]
execute if score #anniR_global anniR_team matches 1 run team join annihilation_team @e[type=item_display,tag=anni_immune,tag=new_sun,distance=..16,limit=1]