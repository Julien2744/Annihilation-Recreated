...
#effect
effect give @e[tag=anni_target,tag=!anni_immune,limit=1,distance=..8] hunger 1 10
effect give @e[tag=anni_target,tag=!anni_immune,limit=1,distance=..8] levitation 1 10
