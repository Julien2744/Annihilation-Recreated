...
#eye_of_war
execute if score @s anniR_abilityCooldown matches 0 unless entity @e[type=skeleton,distance=..90,tag=anni_immune] if score @s anniR_health_pour matches ..70 run execute if predicate annihilation:random_5 run function animated_java:annihilation_recreated/animations/eyes_of_war/play
execute if score @s anniR_abilityCooldown matches 0 unless entity @e[type=skeleton,distance=..90,tag=anni_immune] if score @s anniR_health_pour matches 71.. run execute if predicate annihilation:random_2 run function animated_java:annihilation_recreated/animations/eyes_of_war/play
