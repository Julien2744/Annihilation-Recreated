...
execute if score @s anniR_abilityCooldown matches 0 unless entity @e[type=end_crystal,distance=..90,tag=anni_immune,tag=anni_regen] run execute if score @s anniR_health_pour matches ..30 run execute if predicate annihilation:random_15 run function animated_java:annihilation_recreated/animations/blossoming_chaos/play
