...
execute unless entity @e[type=enderman,tag=anni_immune,nbt={NoAI:1b},limit=1,distance=..3,sort=nearest] run kill @e[type=slime,distance=..3,tag=!anni_hitbox,tag=anni_immune,nbt={NoAI:1b,Size:0}]