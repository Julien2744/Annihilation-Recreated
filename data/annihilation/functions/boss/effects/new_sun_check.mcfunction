...
execute if score @s anniR_newsun_comp matches 200.. run execute if score #anniR_global anniR_newsun_kill matches 1 run kill @a[tag=!anni_immune,distance=..128,gamemode=!creative,gamemode=!spectator]
