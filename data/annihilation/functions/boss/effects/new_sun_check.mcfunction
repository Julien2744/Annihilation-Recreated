...
execute unless score @s anniR_newsun_comp matches 300.. store result entity @e[type=magma_cube,tag=new_sun_hitbox,tag=anni_immune,limit=1,distance=..8,sort=nearest] Size short 1 run scoreboard players get @s anniR_newsun_size
