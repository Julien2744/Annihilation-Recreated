...
execute if score #anniR_load anniR_loadScoreboard matches 1 run execute unless score #anniR_load anniR_scoreboardVersion matches 2 run function annihilation:initialization/init_scoreboard
