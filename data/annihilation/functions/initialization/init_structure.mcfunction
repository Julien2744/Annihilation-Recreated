#place the structure
execute if score #anniR_load anniR_structureTimer matches 1 run forceload add 300 -1230 200 -1330

#remove old summoner if the structure got generated again
execute if score #anniR_load anniR_structureTimer matches 1 run execute positioned 212 -41.5 -1291.05 run kill @e[type=interaction,tag=anni_summoner,distance=..8]
execute if score #anniR_load anniR_structureTimer matches 1 run execute positioned 212 -41.5 -1291.05 run kill @e[type=item_display,tag=anni_item,distance=..8]
execute if score #anniR_load anniR_structureTimer matches 1 run execute positioned 212 -41.5 -1291.05 run kill @e[type=text_display,tag=anni_item_count,distance=..8]
...
execute if score #anniR_load anniR_structureTimer matches 24 run forceload remove 300 -1230 200 -1330
...
## structure version ##
execute if score #anniR_load anniR_structureTimer matches 25 run scoreboard players set #anniR_load anniR_structureVersion 2
