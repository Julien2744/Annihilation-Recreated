...
execute if entity @n[type=marker,tag=anniR.summoning,distance=..16] run data modify entity @n[type=cow,nbt={NoAI:1b,Tags:["anniR.hitbox","anniR.immune"]},distance=..2] Rotation set from entity @n[type=marker,tag=anniR.summoning,distance=..16] Rotation
...
#model
execute as @n[type=cow,nbt={NoAI:1b,Tags:["anniR.hitbox","anniR.immune"]},distance=..2] at @s run function animated_java:annihilation_recreated/summon {args: {}}
execute as @n[type=cow,nbt={NoAI:1b,Tags:["anniR.hitbox","anniR.immune"]},distance=..2] at @s run execute positioned ~ ~8.25 ~ run function animated_java:annir_head/summon {args: {}}
