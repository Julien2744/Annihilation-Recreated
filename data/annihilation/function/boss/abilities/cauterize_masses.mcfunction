...
#facing
execute as @n[type=item_display,tag=aj.annir_head.root,distance=..10] at @s run summon armor_stand ^ ^5 ^8 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["anniR.meteor","anniR.meteor_s_look","anniR.summoned"]}
