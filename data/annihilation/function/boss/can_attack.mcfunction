...
#stoke the blaze
execute unless score @s anniR.buffedCount matches 2 run execute if score @s anniR.isBuffed matches 0 if score @s anniR.health_pour matches 52..65 if score @s anniR.abilityCooldown matches 0 run function annihilation:boss/execute_attack {ID:7}
execute unless score @s anniR.buffedCount matches 2 run execute if score @s anniR.isBuffed matches 0 if score @s anniR.health_pour matches 25..43 if score @s anniR.abilityCooldown matches 0 run function annihilation:boss/execute_attack {ID:7}

#cleasing inferno (short)
execute if score @s anniR.abilityCooldown matches 0 run execute if entity @n[tag=anniR.target,tag=!anniR.immune,distance=6.5..18] if predicate annihilation:random_35 run function annihilation:boss/execute_attack {ID:6}

#apocalyptic sigil
execute if score @s anniR.abilityCooldown matches 0 run execute unless entity @e[type=item_display,tag=aj.annir_apocalyptic_sigil.root,limit=1,distance=..128] if predicate annihilation:random_30 run function annihilation:boss/execute_attack {ID:8}
...
#cauterize_them_all
execute if score @s anniR.health_pour matches ..60 run execute if score @s anniR.abilityCooldown matches 0 if entity @n[tag=anniR.target,tag=!anniR.immune,distance=11.5..128] if predicate annihilation:random_25 run function annihilation:boss/execute_attack {ID:5}
#cauterize_masses
...
#blossoming_chaos
execute if score @s anniR.abilityCooldown matches 0 unless entity @e[type=end_crystal,distance=..90,tag=anniR.immune,tag=anniR.regen] run execute if score @s anniR.health_pour matches 36..70 run execute if predicate annihilation:random_5 run function annihilation:boss/execute_attack {ID:12}
execute if score @s anniR.abilityCooldown matches 0 unless entity @e[type=end_crystal,distance=..90,tag=anniR.immune,tag=anniR.regen] run execute if score @s anniR.health_pour matches ..35 run execute if predicate annihilation:random_15 run function annihilation:boss/execute_attack {ID:12}

#death beams
execute if score @s anniR.health_pour matches 45..90 if score @s anniR.abilityCooldown matches 0 run execute unless entity @e[type=item_display,tag=aj.annir_death_beams.root,limit=1,distance=..128] if predicate annihilation:random_5 run function annihilation:boss/execute_attack {ID:11}
execute if score @s anniR.health_pour matches ..44 if score @s anniR.abilityCooldown matches 0 run execute unless entity @e[type=item_display,tag=aj.annir_death_beams.root,limit=1,distance=..128] if predicate annihilation:random_8 run function annihilation:boss/execute_attack {ID:11}
