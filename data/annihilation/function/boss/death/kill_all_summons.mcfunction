...
kill @e[type=zombified_piglin,tag=anniR.immune,tag=anniR.summoned,distance=..128]
kill @e[type=end_crystal,tag=anniR.immune,tag=anniR.summoned,distance=..128]
kill @e[type=wither_skeleton,tag=anniR.immune,tag=anniR.summoned,distance=..128]
