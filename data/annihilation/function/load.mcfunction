...
execute if score #anniR.load anniR.loadStructure matches 1 run execute unless score #anniR.load anniR.structureVersion matches 3 run schedule function annihilation:version_warning 5s