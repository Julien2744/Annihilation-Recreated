...
attribute @s generic.attack_speed modifier add annir.sigil_buff 0.5 add_multiplied_base
attribute @s generic.movement_speed modifier add annir.sigil_buff 0.04 add_value
