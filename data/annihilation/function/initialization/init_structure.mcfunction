...
execute if score #anniR.load anniR.structureTimer matches 24 run execute positioned 212 -39 -1292 run function annihilation:boss_summoner/summon
...
## structure version ##
execute if score #anniR.load anniR.structureTimer matches 25 run scoreboard players set #anniR.load anniR.structureVersion 2
