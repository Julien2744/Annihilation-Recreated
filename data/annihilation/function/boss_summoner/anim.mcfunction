...
execute unless score #anniR.global anniR.boss_summoner matches 1 run execute as @e[type=marker,tag=anniR.summoning,limit=1] at @s rotated ~180 ~ positioned ^ ^3 ^1.75 run function annihilation:boss/effects/sigil_small
