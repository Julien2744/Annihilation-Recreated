scoreboard players set @s aj.annihilation_recreated.animation.blossoming_chaos.local_anim_time 0
...
function animated_java:annihilation_recreated/zzzzzzzz/animations/blossoming_chaos/tree/leaf_0
